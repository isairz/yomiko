<template>
  <div>
    <nav class="nav is-shadow">
      <div class="container ">
        <div class="navbar-brand">
          <nuxt-link to="/" class="navbar-item is-brand is-bold">
            Project Yomiko
          </nuxt-link>

          <a class="navbar-item is-hidden-desktop" href="https://twitter.com/prev_ious" target="_blank">
